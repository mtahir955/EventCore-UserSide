...
export function MyCompEventsCard({
  id,
  imageSrc,
  price,
  isEditEvent,
  ...
  //   router.push(`/completed-events/edit`);
  // };

  const handleEventDetails = () => {
    if (!id) return;
    router.push(`/completed-events/edit?id=${id}`);
  };
    ...
    <>
      <div className="relative rounded-2xl overflow-hidden w-full">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(0,0,0,0) 20%, rgba(0,0,0,0.75) 100%)",
          }}
        />
