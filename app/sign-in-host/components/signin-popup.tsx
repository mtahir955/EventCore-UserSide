  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(
        ...
        {
          headers: {
            "x-tenant-id": "fc36df79-3157-44fb-9c5a-fbc938f2fda7", // ✅ SAME AS ADMIN
      ...
      // ✅ FIX – backend returns access_token (not accessToken)
...
//   // ⭐ FULL BACKEND LOGIN API INTEGRATION (Same as Admin)
//   const handleSubmit = async (e: React.FormEvent) => {
//     e.preventDefault();
...
//         {
//           headers: {
//             "x-tenant-id": "883e6f70-8923-4c72-bf04-66905d24d736", // same as admin for now
//             "Content-Type": "application/json",
//           },
//         }
//       );
...
//         localStorage.setItem("hostToken", response.data.accessToken); // 👈 host token
//       }
