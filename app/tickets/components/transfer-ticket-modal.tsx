              ...
              {[
                ...
                <div key={i}>
                  ...
                  <input
                    ...
                    className="w-full h-9 md:h-10 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#222222] px-4 text-[13px] md:text-[14px] text-black dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0077F7]"
                  />
                </div>
              ))}
