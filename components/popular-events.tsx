...
//           <h2 className="text-4xl font-bold text-[#000000] dark:text-white mb-3 transition-colors">
//             Popular{" "}
//             <span className="text-[#89FC00] italic font-bold">Events</span>
//           </h2>
//           <p className="text-gray-600 dark:text-gray-300 text-base transition-colors">
...
//         {/* Filter tabs */}
//         <div className="relative w-full overflow-x-hidden no-scrollbar mb-12 flex justify-center">
//           <div
//             ref={scrollRef}
...
//                   {/* Price */}
//                   <div className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-white/95 dark:bg-[#1E1E1E]/95 px-3 py-1 rounded-full">
...
//                       >
//                         <Star className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-700 dark:text-gray-300" />
//                       </Button>
//                     </div>

//                     <h3 className="text-white text-lg sm:text-xl font-bold mb-2 line-clamp-1 sm:line-clamp-2">
//                       {event.title}
//                     </h3>
...
//                       <div className="flex items-center gap-1 min-w-[45%] sm:min-w-0">
...
//           <Link href="/events">
//             <button className="bg-[#0077F7] hover:bg-[#0066D6] text-white sm:px-10 sm:py-3 px-6 py-3 rounded-full font-medium transition-colors">
//               View More
//             </button>
//           </Link>
//           <Link href="/about-us">
//             <button className="bg-white hover:bg-gray-100 text-[#000000] dark:bg-white dark:hover:bg-gray-200 dark:text-[#000000] sm:px-10 sm:py-3 px-6 py-3 rounded-full font-medium border-2 border-gray-200 transition-colors">
//               About Us
//             </button>
//           </Link>
//         </div>
...
export function PopularEvents({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      el.scrollLeft += scrollDir * speed;
      if (el.scrollLeft + el.clientWidth >= el.scrollWidth - 1) setScrollDir(-1);
      else if (el.scrollLeft <= 0) setScrollDir(1);
      frame = requestAnimationFrame(animate);
    };
    frame = requestAnimationFrame(animate);
  ...
  useEffect(() => {
    ...
    if (searchQuery) {
      ...
      filtered = filtered.filter((event) => {
        ...
        const matchesDate = !date || event.date.toLowerCase().includes(date.toLowerCase());
